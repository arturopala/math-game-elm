...
Elm.Example.make = function (_elm) {
   ...
   var update = F2(function (message,model) {    var _p0 = message;return {ctor: "_Tuple2",_0: model,_1: $Effects.none};});
   var Noop = {ctor: "Noop"};
   var Model = {};
   var init = {ctor: "_Tuple2",_0: Model,_1: $Effects.none};
   return _elm.Example.values = {_op: _op,Model: Model,init: init,Noop: Noop,update: update,view: view};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var app = $StartApp.start({init: $Example.init,update: $Example.update,view: $Example.view,inputs: _U.list([])});
   var main = app.html;
